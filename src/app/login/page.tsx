...
function page() {
    ...
    return (
        <div className='mx-auto max-w-[90%] lg:max-w-[30%] p-6 lg:p-8 bg-zinc-200/50 rounded-3xl mt-[30%] lg:mt-[10%]'>
            <h1 className='text-transparent text-[1.8rem] lg:text-[2rem] font-bold text-center bg-clip-text bg-gradient-to-br from-blue-950 to-slate-900'>LOG-IN FORM</h1>
            <form className='mt-5 w-full' onSubmit={submitDetails}>
                ...
                <Link href="/signup"><p className="text-[1rem] text-right mt-3 underline">Go To Sign-up</p></Link >
            </form>
        </div>
    )
}
